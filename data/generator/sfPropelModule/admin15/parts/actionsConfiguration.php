...
<?php unset($this->config['actions']) ?>
  ...
  {
    return <?php echo $this->asPhp(isset($this->config['form']['actions']) ? $this->config['form']['actions'] : array('_delete' => null, '_list' => null, '_save' => null, '_save_and_add' => null, '_save_and_list' => null)) ?>;
